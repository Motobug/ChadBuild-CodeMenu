...
#if DOLPHIN_BUILD
	MainLines.push_back(new Comment("Chad Build Netplay Code Menu", &MENU_TITLE_CHECK_LOCATION));
#else
	MainLines.push_back(new Comment("Chad Build Code Menu", &MENU_TITLE_CHECK_LOCATION));
#endif
...
#if DOLPHIN_BUILD
	MainLines.push_back(new Selection("Stagelist", { "PMBR", "Middle 3", "2023 Proposed", "Ontario", "NUTS", "Australia", "All"}, 1, STAGELIST_INDEX));
#else
	MainLines.push_back(new Selection("Stagelist", { "PMBR", "Middle 3", "2023 Proposed", "Ontario", "NUTS", "Australia", "All"}, 1, STAGELIST_INDEX));
#endif
